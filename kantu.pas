...
uses
  ...
  kantu_main, kantu_definitions, kantu_simulation,
  kantu_pricepattern, kantu_filters, kantu_custom_filter, SysUtils, Controls,
  Graphics, Dialogs, Menus, Grids, StdCtrls, ComCtrls, Buttons,
  Classes, kantu_loadSymbol, kantu_multithreading, kantu_portfolioResults,
