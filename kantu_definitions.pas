...
type
  TIndicatorPatternGroup = array of TIndicatorPattern;
...
const
  ...
  KANTU_VERSION = '2025.0.9';
  KANTU_NAME='OpenKantu 2025';

{$IFDEF DELPHI}
const
OptionNames:array of string=   ['Number of rules','Max Shift','Shift variation step','StopLoss (if fixed)','TakeProfit (if fixed)','TrailingStop (if fixed)','Hour (if fixed)','SL/TP/TL Shift variation Step','Max SL/TP/TL ','Number of Cores','Bars used for ME analysis','Number of requested systems'];
