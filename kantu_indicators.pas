...
begin
  ...
  try // try to calculate statistics
    ...
    // fits to y = m*x+b
    try
      LinearLeastSquares(dataForFit, m, b, r);
    except
      on Exception do
    ...
    begin
      ...
      begin
        ...
        try
          LinearLeastSquaresNormal(dataforFit2, m, b, r);
        except
          on Exception do
            //
        end;
...
{$ENDIF}
  ...
  MainForm.StatusLabel.Caption :=
    ('Loaded data for symbol ' + LoadedIndiHistoryData[n].symbol +
